function prepareImages(images) {
    ...
    finalImages.good_0 = Dom.imageSplit(images.img_good0, 0, 0, 48, 48, 0.6);
    finalImages.good_1 = Dom.imageSplit(images.img_good1, 0, 0, 48, 48, 0.6);
    // finalImages.good_2 = Dom.imageSplit(images.img_good2, 0, 0, 36, 47, 0.7);
    finalImages.good_2 = Dom.imageSplit(images.img_good4, 0, 0, 48, 48, 0.6);
